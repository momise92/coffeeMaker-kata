...
public class Latte extends Coffee {
    ...
    public Latte(List<Ingredient> ingredients) {
        super(CoffeeType.LATTE, ingredients);
    }
    ...
    private boolean isValid(List<Ingredient> ingredients) {
        ...
        removeIfIngredientInList(copyIngredients, IngredientName.WATER, 37, Unit.ML);
        removeIfIngredientInList(copyIngredients, IngredientName.MILK, 170, Unit.ML);
